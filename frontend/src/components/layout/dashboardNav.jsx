// Shared navigation config for the dashboard, used by both the desktop sidebar
...
export const NAV = [
  ...
  { href: '/invoices/new', label: 'New Invoice', icon: IconNew },
...
export function isNavItemActive(pathname, href) {
  if (href === '/invoices') {
    // Keep "Invoices" active on detail pages but not on /invoices/new
